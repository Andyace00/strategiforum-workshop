...
DEFAULT_ROUNDS: Dict[str, dict] = {
    ...
    "r5_satellitter": {
        ...
        "question": "Ti lokasjoner — for hver: vurder aktivitetene som tilbys i dag. Kan de flyttes til en hovedadresse, må de vurderes nærmere, eller er de urørlige?",
        "type": "categorized",
        "categories": ["Kan flyttes", "Må vurderes", "Urørlig"],
        "pre_items": [
            "Toppenhaug (480 kvm, eid — kafé/quiz/bingo/snekker/fotpleie)",
            "Kolben seniorsenter (520 kvm, leid — kafé/trening/quiz/festsal)",
            "Svingen (655 kvm, eid — kafé/sløyd/håndarbeid/språkkurs)",
